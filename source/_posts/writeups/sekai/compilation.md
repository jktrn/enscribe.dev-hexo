---
title: "SekaiCTF 2022: Writeup Compilation"
...
![Screenshot of the `moz_places` table in `places.sqlite`](/asset/sekai/sqlite.png)
...
files: "[Assignment-broken.xps](/asset/sekai/Assignment-broken.xps)"
{% endchallenge %}
...
![Viewing the renamed `.xps` file in WinRAR](/asset/sekai/zip.png)

In `Resources/` we can find `02F30FAD-6532-20AE-4344-5621D614A033.odttf`, which is an "Obfuscated OpenType" file:

![Viewing `Resources/` file in WinRAR](/asset/sekai/odttf.png)
...
![Conversion using odttf2ttf](/asset/sekai/conversion.png)
...
![Viewing unordered glyphs in default font viewer](/asset/sekai/fontviewer.png)
...
![Inspecting the "Lookup" tab in FontForge](/asset/sekai/lookup.png)
...
![Inspecting stylistic set ruleset $2 in FontForge](/asset/sekai/ruleset.png)
...
![MEW dashboard](/asset/sekai/dashboard.png)
