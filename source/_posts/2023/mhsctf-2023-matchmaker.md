...
![Graph](/static/mhsctf-2023/graph.svg)
...
![Matching](/static/mhsctf-2023/matching.svg)
...
![Weights](/static/mhsctf-2023/weights.svg)
...
![Augmenting Paths](/static/mhsctf-2023/augmenting-paths.svg)
...
![Augmented Path](/static/mhsctf-2023/augmented-path.svg)
...
![Blossom](/static/mhsctf-2023/blossom.svg)
...
![Blossom Contraction](/static/mhsctf-2023/blossom-contraction.svg)

From there, we can find valid augmenting paths to augment $M$:

![Augmented Blossom](/static/mhsctf-2023/augmented-blossom.svg)

Finally, we can expand the blossom $B$ back into its original form, to reveal the maximum matching:

![Expanded Blossom](/static/mhsctf-2023/expanded-blossom.svg)
...
![Scary Math](/static/mhsctf-2023/scary-math.png)
...
![Biweight](/static/mhsctf-2023/biweight.svg)
