...
{% ccb html:true terminal:true %}
<span class="meta prompt_">home/sekaictf$</span> tree | grep -C 5 firefox
│   ├── german.png
│   ├── ginger.png
│   └── meme.png
├── Public
...
![Screenshot of the `moz_places` table in `places.sqlite`](/static/sekaictf-2022/sqlite.png)
...
{% ccb html:true terminal:true %}
<span class="meta prompt_">home/sekaictf/Documents$ </span><span class="built_in">ls</span>
...
{% cimage src:/static/sekaictf-2022/execution.png width:600px %}
...
![Screenshot of pure HTML page with a suspicious wget command](/static/sekaictf-2022/sussy.png)
...
files: "[Assignment-broken.xps](/static/sekaictf-2022/Assignment-broken.xps)"
{% endchallenge %}
...
![Viewing the renamed `.xps` file in WinRAR](/static/sekaictf-2022/zip.png)

In `Resources/` we can find `02F30FAD-6532-20AE-4344-5621D614A033.odttf`, which is an "Obfuscated OpenType" file:

![Viewing `Resources/` file in WinRAR](/static/sekaictf-2022/odttf.png)
...
![Conversion using odttf2ttf](/static/sekaictf-2022/conversion.png)
...
![Viewing unordered glyphs in default font viewer](/static/sekaictf-2022/fontviewer.png)
...
![Visible flag in program window for FontForge](/static/sekaictf-2022/broken-converter-flag-fontforge.png)
...
![Inspecting the "Lookup" tab in FontForge](/static/sekaictf-2022/lookup.png)
...
![Inspecting stylistic set ruleset $2 in FontForge](/static/sekaictf-2022/ruleset.png)
...
![Changing stylistic sets on FontDrop!](/static/sekaictf-2022/mono-flag.gif)
...
{% ccb html:true terminal:true %}
<span class="meta prompt_">$ </span>git <span class="built_in">clone</span> https://github.com/volatilityfoundation/volatility3.git
<span class="meta prompt_">$ </span><span class="built_in">cd</span> volatility3
{% endccb %}
...
<span class="meta prompt_">$ </span>python3 vol.py -f dump.mem banner
...
{% ccb html:true terminal:true %}
<span class="meta prompt_">$ </span>git <span class="built_in">clone</span> https://github.com/volatilityfoundation/dwarf2json  
<span class="meta prompt_">$ </span><span class="built_in">cd</span> dwarf2json 
<span class="meta prompt_">$ </span>go build  
{% endccb %}
...
{% ccb html:true terminal:true wrapped:true %}
<span class="meta prompt_">$ </span>python3 vol.py -f dump.mem linux.bash
Volatility 3 Framework 2.3.1
...
{% ccb html:true terminal:true %}
<span class="meta prompt_">$ </span>python3 vol.py -f dump.mem linux.psaux
Volatility 3 Framework 2.3.1
Progress:  100.00        Stacking attempts finished                 
PID PPID    COMM    ARGS
...
...
{% ccb html:true terminal:true %}
<span class="meta prompt_">$ </span>python3 file.pyc password
...
<span class="meta prompt_">$ </span>python3 disassembled.py 
  1           0 LOAD_CONST               0 (0)
              2 LOAD_CONST               1 (None)
              4 IMPORT_NAME              0 (sys)
              6 STORE_NAME               0 (sys)
...
{% ccb html:true terminal:true wrapped:true %}
<span class="meta prompt_">$ </span>python3 mnemonic.py
...
![MEW dashboard](/static/sekaictf-2022/dashboard.png)

To access the private key, go to `My personal account` -> `View paper wallet`:

![Viewing wallet](/static/sekaictf-2022/wallet.png)
